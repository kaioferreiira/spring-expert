...
public class Cerveja implements Serializable {
	...
	@SKU
	@NotBlank(message = "SKU é obrigatório") //verifica se a string nao é nula e senão esta vazia
	private String sku;
	
	@NotBlank(message = "Nome é obrigatório")// Nomé é obrigatorio e nao pode esta vazio
	private String nome;
